//Mapeach class of actors

//here are the variables for our actors
//lab7
var actorChars = {
  "@": Player,
...
Level.prototype.obstacleAt = function(pos, size) {
  ...
  for (var y = yStart; y < yEnd; y++) {
    for (var x = xStart; x < xEnd; x++) {
      ...
      //another alternative perhaps better (to modify above line):
      //(and this makes it so floater is never returned as an obstacle):
...
var wobbleSpeed = 10; //original: 8
wobbleDist = 0.2; //original: 0.07
